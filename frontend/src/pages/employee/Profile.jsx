...
export default function EmployeeProfile() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow">
      ...
      <div className="mt-8">
        <h4 className="font-medium mb-4">My Performance Gauges</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="border rounded p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="font-medium">Gauge 1</div>
          ...
          <div className="border rounded p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="font-medium">Gauge 2</div>
              <div className="flex items-center gap-2">
        ...
        <div className="text-sm text-gray-600 mt-2">Each gauge shows the average of all KRA review scores for the selected month.</div>
      </div>
      {cpOpen && (
